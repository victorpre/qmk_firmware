...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FL] = LAYOUT_60_ansi_split_bs_rshift(
		...
		KC_TRNS,          RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, KC_MPLY, KC_SLCK, KC_PAUS, RESET,
		...
		KC_TRNS, KC_TRNS,          KC_TRNS,                   KC_TRNS,                            KC_MPRV, KC_MNXT,          KC_VOLD, KC_VOLU
    )
};
