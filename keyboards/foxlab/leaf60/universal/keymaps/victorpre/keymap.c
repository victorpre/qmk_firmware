...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_all(
		...
		KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(_FN1),
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, LT(_NAV, KC_SPC), KC_RALT, MO(_FN1), KC_RGUI, KC_RCTL),
