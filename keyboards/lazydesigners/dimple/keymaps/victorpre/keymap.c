 ...
 */
	...
	[_QWERTY] = LAYOUT(
		...
		SFT_CPS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, MO(_FUNC),
 ...
 */
	...
	[_RAISE] = LAYOUT(
		...
		KC_INS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT, KC_BSLS,
